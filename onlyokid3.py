...
\033[1;37m
\033[1;37m------------------------------------------------
\033[1;37m Owner   :            Md Imran Mia
\033[1;37m Facebook:            https://www.facebook.com/siimranmiamd
\033[1;37m Github  :            King-Haker0134
...
def cutter():
    ...
    print(" ")
    sarfraz = input('Saving Put File Name:')
    os.system('touch ' +Imran)
    os.system('sort -r '+ssb+' | uniq > '+Imran)
    os.system('clear')
    print(logo)
    print("Removed Successful From File: " + ssb )
    print("New File Saved:" + Imran)
    print(47*'-')
    input(f"{S} Press Enter To Back SSB Menu ")
    SSB(allkey)       
